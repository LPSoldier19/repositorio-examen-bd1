...
IF @existenRegistros > 0 BEGIN
    ...
    SELECT 0 as Successed, 'Ya hay datos en la tabla' as MSG
...
INSERT INTO example.fact_summary (CustomerID,CustomerName,SupplierID,SupplierName,Mes,Anio,Total,SuperoPromedio,PorcentajeVentaMensual)
    SELECT 
    c.CustomerID,
    c.CustomerName,
    s.SupplierID,
